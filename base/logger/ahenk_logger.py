...
class Logger(object):
    ...
    def debug(self, message):
        message = self.replace_turkish_characters(message)
    ...
    def replace_turkish_characters(self, message):
        message = str(message).replace("ş", "s")
        message = str(message).replace("ö", "o")
        message = str(message).replace("ğ", "g")
        message = str(message).replace("ç", "c")
        message = str(message).replace("ü", "u")
        message = str(message).replace("Ş", "S")
        message = str(message).replace("Ö", "O")
        message = str(message).replace("Ğ", "G")
        message = str(message).replace("Ç", "C")
        message = str(message).replace("Ü", "U")
        message = str(message).replace("İ", "I")
        return message
